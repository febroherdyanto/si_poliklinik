...
<?php $getnip = $_GET['nip']; 
$qtampil = mysql_query("select * from pegawai where NIP='$getnip'");
while($t = mysql_fetch_array($qtampil)){
...
<script type="text/javascript">
	...
	<div class="row form-group">
		...
		<div class="col-md-9">
			...
			<hr>
<?php } 
$qtu = mysql_query("select * from user where NIP='$getnip'");
while($u = mysql_fetch_array($qtu)){?>
...
if($_POST['password'] == NULL){
	...
	$q1 = mysql_query("update pegawai set nama_pegawai='$nama_pegawai', 
		alamat_pegawai='$alamat_pegawai', telp_pegawai='$telp_pegawai',
		tgl_lahir_pegawai='$tgl_lahir_pegawai', jenkel_pegawai='$jenkel_pegawai'
		where NIP='$getnip'");
	$q2 = mysql_query("update user set level_user='$level_user' where NIP='$getnip'");
	...
	$qe1 = mysql_query("update pegawai set nama_pegawai='$nama_pegawai', 
		alamat_pegawai='$alamat_pegawai', telp_pegawai='$telp_pegawai',
		tgl_lahir_pegawai='$tgl_lahir_pegawai', jenkel_pegawai='$jenkel_pegawai'
		where NIP='$getnip'");
	$qe2 = mysql_query("update user set password='$password',
