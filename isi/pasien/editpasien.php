...
<?php
$getno = $_GET['no'];
$qtampil = mysql_query("select * from pasien where no_pasien='$getno'");
...
$query = mysql_query("update pasien set nama_pasien='$nama_pasien', 
...
if($query == 1){
	...
	echo "GAGAL EDIT DATA PASIEN ".mysql_error();
}
}
?>